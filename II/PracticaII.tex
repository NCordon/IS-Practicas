...
\begin{answer}
  ...
  En la \ref{c6-1} se aprecia como se rechaza cualquier conexión SSH al puerto 22,
...
\begin{answer}
  ...
  Creamos el fichero en \texttt{/var/www/html/}. Todo ello se aprecia en la \ref{c9-1}
  ...
  \imagen{../images/2c9-5.jpeg}{Usamos la base de datos mysql}{c9-5}{1}
...
\begin{answer}
  ...
  \imagen{../images/2c10-1.jpeg}{Página de prueba creada}{c10-1}{1}
\end{answer}
