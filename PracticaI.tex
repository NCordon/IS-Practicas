...
O otra alternativa es configurar una conexión Bridge Network entre la máquina host y la guest (esto es el equivalente a que
ambas máquinas estuviesen conectadas por un cable Ethernet físico), y una de tipo Internal Network para que las máquinas
virtuales pudiesen verse entre sí (haría falta configurar esta útlima en todas los guests).

Se ha escogido la primera alternativa. En la imagen \ref{net} se observa cómo se hace un \texttt{ifconfig} en la máquina
...
\imagen{./images/net.jpg}{Configuración de network entre host y guest}{net}{1.1}
