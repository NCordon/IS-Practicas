...
y FreeBSD, y permite virtualizar sistemas operativos Linux, Windows, DOS, Mac OS X, Solaris y OpenBSD. Tiene licencia
GPL para uso particular. Es propietario en su versión comercial para empresas.
...
de coste para uso personal. Permite virtualizar los mismos sistemas operativos que VirtualBox, además de BeOS, Darwin,
Netware, \ldots
